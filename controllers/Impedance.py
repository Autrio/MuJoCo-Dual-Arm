...
class Impedance:
    ...
    def makeplots(self):
        ...
        plt.tight_layout()
        plt.savefig("Figures/Grasp_5/5/position_orientation.png")
        # plt.show()
        ...
        plt.tight_layout()
        plt.savefig("Figures/Grasp_5/5/errors.png")
        # plt.show()
        ...
        plt.tight_layout()
        plt.savefig("Figures/Grasp_5/5/joint_trajectories.png")
        # plt.show()
        ...
        plt.tight_layout()
        plt.savefig("Figures/Grasp_5/5/object_trajectories.png")
        ...
        plt.tight_layout()
        plt.savefig("Figures/Grasp_5/5/ft_sensor_data.png")
        plt.show()