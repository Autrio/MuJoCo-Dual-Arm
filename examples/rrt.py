...
class RRT:
    ...
    def steer(self, from_node, to_node, extend_length=float("inf")):
        ...
        d, theta, phi = self.calc_distance_and_angle(self,new_node, to_node)
        ...
        for _ in range(n_expand):
            new_node.x += self.path_resolution * math.cos(theta) * math.sin(phi)
            new_node.y += self.path_resolution * math.sin(theta) * math.sin(phi)
            new_node.z += self.path_resolution * math.cos(phi)
            new_node.path_x.append(new_node.x)
            new_node.path_y.append(new_node.y)
            new_node.path_z.append(new_node.z)

        d, _, _ = self.calc_distance_and_angle(self, new_node, to_node)
